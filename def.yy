...
czynnik
		...
		|	LR						{fprintf(file, " %f", $1); string float_name = "float_val_" + to_string(float_num); float_num++; insert_symbol(float_name, FLOAT_TYPE, $1); argstack.push(Element(LR, to_string($1)));}
		|	'(' wyr ')'				{fprintf(file, " ");}
		;
%%
